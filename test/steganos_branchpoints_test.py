...
class TestSteganosBranchpoints(object):
    ...
    def test_encode_a_single_bit(self):
        # given
        text = '"I am 9," he said.'
        bits = '1'
    ...
    def test_encode_raises_when_given_too_many_bits_for_text(self):
        # given
        text = 'x'
        bits = '110'
    ...
    def test_decode_a_single_bit(self):
        # given
        text = '"I am 9." he said.'
        bits = '1'
        encoded_text = steganos.encode(bits, text)
    ...
    def test_decode_with_bad_origin(self):
        # given
    ...
    def test_encoding_when_digits_appear_before_quotes(self):
            # given
    ...
    def test_get_indices_of_encoded_text_when_text_is_at_start(self):
        # given
    ...
    def test_get_indices_when_encoded_text_not_at_start(self):
        # given
    ...
    def test_get_indices_when_change_is_not_start_of_encoded_text(self):
        # given
        text = 'Chapter 9 - "Hello!", Chapter 10 - "Goodbye!"'
    ...
    def test_get_indices_when_end_is_mid_change_in_encoded(self):
        # given
        text = 'Chapter 9 - "Hello!", Chapter 8 - "Goodbye!"'
    ...
    def test_get_indices_when_start_is_mid_change_in_original(self):
        # given
        text = "I won't do it."
    ...
    def test_get_indices_when_end_is_mid_change_in_original(self):
        # given
        text = "I won't."
        encoded_text = "I will"
    ...
    def test_get_indices_when_start_is_mid_unchanged_change_in_original(self):
        # given
        text = "I won't turn 9"
    ...
    def test_get_indices_when_end_is_mid_unchanged_change_in_original(self):
        # given
        text = "I won't turn 9."
        encoded_text = "I wo"
    ...
    def test_when_global_change_out_of_encoded_text(self):
        # given
    ...
    def test_local_changes_appear_after_global_changes_in_decoded_bits(self):
        # given
        text = 'I am 9\t, but I say "I am 8".'
    ...
    def test_global_change_late_in_encoded_text_with_negative_indices(self):
        # given
        text = 'I am 9\t, but I say "I am 8".'
        encoded_text = steganos.encode('111', text)
    ...
    def test_global_change_late_in_encoded_text(self):
        # given
        text = 'I am 9\t, but I say "I am 8"'
        encoded_text = steganos.encode('111', text)
    ...
    def test_get_all_branchpoints_finds_matching_quotes(self):
        # given
        text = '"Hello," he said.'
